...
class ChatScreen(tk.Canvas):
    def __init__(self, parent, first_frame, client_socket, clients_connected, user_id):
        ...
        button_style = {"fg": "#83eaf7", "font": "lucida 11 bold", "bg": "#444444",
                        "relief": "flat", "bd": 3, "padx": 10, "pady": 5}   
        # Send Button
        send_button = tk.Button(self, text="Send", command=self.sent_message_format, **button_style)
        send_button.place(x=465, y=670,width=60, height=40)  # Adjusted position for better spacing
